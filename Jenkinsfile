            ...
            steps {
                ...
                script {
                    dir('microservice') {
                        ...
                        sh 'aws eks update-kubeconfig --name sockshop-eks --region eu-west-3 --kubeconfig .kube/config'
                        sh 'kubectl apply -f ../ingress/manifests/rbac.yaml --kubeconfig .kube/config'
                        sh 'kubectl apply -f ../ingress/manifests/shop-namespace.yaml --kubeconfig .kube/config'
                        ...
                        sh 'kubectl apply -f ../ingress/manifests/ingress.yaml -n $NAMESPACE --kubeconfig .kube/config'
                    }
                }
            }
        }
